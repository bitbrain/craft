...
public interface API {
  ...
  /**
   * Provides all items which are owned by the given player. Contains also items which can be possibly crafted but are
   * not really there.
   * 
   * @param playerId
   *          id of the player
   ...
   * @throws APIException
   *           Is thrown if player already exists
   */
   ...
   * @param itemId
   *          target item
   * @param deferredSoundId
   *          sound file name
   * @param type
   *          event type when the sound should occur
   * @param pitch
   ...
   * 
   * @param profession
   *          the professsion which should be affected
   * @param xp
   *          amount of xp to add
