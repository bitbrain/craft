...
public final class Assets {
	...
	public static final String PRT_GREEN_SMALL = DIR_PARTICLES
			+ "particles-green-small.p";

	// ---------- BUNDLES -----------

	public static final String BDL_GENERAL = DIR_LANGUAGE + "general";
	public static final String BDL_ITEMS = DIR_LANGUAGE + "items";
	public static final String BDL_ITEMS_DESCRIPTIONS = DIR_LANGUAGE
			+ "items-description";
	...
	public static final String TEX_TAB_GRADIENT = DIR_IMAGES
			+ "ui/tab_gradient.png";
	public static final String TEX_CURSOR = DIR_IMAGES + "cursor.png";
	public static final String TEX_BACKGROUND_01 = DIR_IMAGES
			+ "background.png";
	...
	public static final String TEX_BUTTON_GREEN_DARK = DIR_IMAGES
			+ "button_down.png";
	public static final String TEX_BUTTON_RED_DARK = DIR_IMAGES
			+ "button_red_down.png";
	public static final String TEX_JEWELER_PREVIEW = DIR_IMAGES
			+ "icons/ico_jewel_diamond_medium.png";
	public static final String TEX_ENGINEER_PREVIEW = DIR_IMAGES
			+ "icons/ico_fab_power_medium.png";
	public static final String TEX_ALCHEMIST_PREVIEW = DIR_IMAGES
			+ "icons/ico_alchemy_flasks_overview.png";
	public static final String TEX_PANEL_SMALL_H = DIR_IMAGES
			+ "panel_small_horizontal.png";
	public static final String TEX_PANEL_SMALL_L_H = DIR_IMAGES
			+ "panel_small_light_horizontal.png";
	public static final String TEX_PANEL_9patch = DIR_IMAGES + "ui/panel.9.png";
	public static final String TEX_PANEL_TRANSPARENT_9patch = DIR_IMAGES
			+ "ui/panel_transparent.9.png";
	public static final String TEX_PANEL_BLACK_9patch = DIR_IMAGES
			+ "ui/panel_black.9.png";
	public static final String TEX_PANEL_HIGHLIGHT_9patch = DIR_IMAGES
			+ "ui/panel_highlight.9.png";
	public static final String TEX_PANEL_TAB_9patch = DIR_IMAGES
			+ "ui/panel_tab.9.png";
	public static final String TEX_PANEL_TAB_ACTIVE_9patch = DIR_IMAGES
			+ "ui/panel_tab_active.9.png";
	public static final String TEX_PANEL_BAR_9patch = DIR_IMAGES
			+ "ui/panel_bar.9.png";
